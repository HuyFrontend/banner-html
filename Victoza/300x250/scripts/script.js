    ...
    var $banner = {
        ...
        mainDOM: function() {
            ...
            function mainFunc() {
                ...
                Tween.add(TweenLite.to(['#descFirst'], 1, { autoAlpha: 1 }), timers);
                
                // step 2
                Tween.add(TweenLite.to(['#descFirst'], 1, { autoAlpha: 0 }), timers + 0.5);
                Tween.add(TweenLite.to(['#descSecond'], 1, { autoAlpha: 1 }), timers + 0.5);

                // step 3
                Tween.add(TweenLite.to(['#descSecond'], 1, { autoAlpha: 0 }), timers + 0.5);
                Tween.add(TweenLite.to([
                    '#background', 'titleFirst'
                ], 1, { autoAlpha: 1 }), timers + 0.5);
                //Tween.add(TweenLite.to(['#ti'], 1, { autoAlpha: 1 }), timers + 0.5);
