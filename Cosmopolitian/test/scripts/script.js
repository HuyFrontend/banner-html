    ...
    var $banner = {
        ...
        mainDOM: function() {
            ...
            function mainFunc() {
                ...
                Tween.add(TweenLite.to(['#background'], 1, { autoAlpha: 1 }), timers);
                timers += .5;
                
                Tween.add(TweenLite.to(['#title-begin'], 1, { autoAlpha: 1 }), timers);
                Tween.add(TweenLite.to(['#bottom-text'], 1, { autoAlpha: 1 }), timers);
                Tween.add(TweenLite.to(['#bottom-gift'], 1, { autoAlpha: 1 }), timers);
